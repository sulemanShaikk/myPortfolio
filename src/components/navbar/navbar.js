  ...
  return (
    <nav className='navbar'>
      ...
      <div className='desktopMenu'>
        <Link to="intro" spy={true} smooth={true} offset={-100} duration={100} activeClass='active' className='desktopMenuListItem'>Home</Link>
        <Link to="skills" spy={true} smooth={true} offset={-100} duration={100} activeClass='active' className='desktopMenuListItem'>Bio</Link>
        <Link to="works" spy={true} smooth={true} offset={-100} duration={100} activeClass='active' className='desktopMenuListItem'>Portfolio</Link>
        <Link to="clients" spy={true} smooth={true} offset={-100} duration={100} activeClass='active' className='desktopMenuListItem'>About</Link>
